...
public class tp1_8 extends JFrame {
    ...
    public tp1_8() {
        ...
        submitButton.addActionListener(e -> {
            try {
                ...
                float resultado2=(float)((per1+per2+per3+per4)*1.95);
         ...
         submitButton.addActionListener(e -> {
            try {
                ...
                float resultado1=(float)((man1+man2+man3+man4)*2.35) ;
